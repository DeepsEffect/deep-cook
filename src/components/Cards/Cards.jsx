...
const Cards = () => {
  ...
  return (
    <section className="mt-16 text-center min-h-screen">
      ...
      <p className="text-base font-normal max-w-2xl mx-auto mt-4">
      ...
      <div className=" border border-red-500 lg:flex justify-between gap-4 mt-6">
        {/* cards */}
        ...
        <div className="border-2 lg:w-2/5 p-4">
